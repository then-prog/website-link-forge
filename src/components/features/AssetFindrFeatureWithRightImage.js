...
const TextColumn = styled(Column)(props => [
  ...
  props.textOnLeft ? tw`md:mr-10 lg:mr-0 md:order-first` : tw`md:ml-12 lg:ml-16 md:order-last`
]);
...
const Heading = tw(
  SectionHeading
)`mt-4 font-semibold text-[#0C162C] text-left text-3xl sm:text-4xl lg:text-5xl md:text-left leading-tight sm:text-left`;
...
const StepHeading = tw.span`leading-none text-xl font-normal text-[#0C162C]`;


export const TwoColumnDesktop = styled.div`
  ${tw`hidden lg:flex flex-col md:flex-row justify-between max-w-screen-xl ml-24 mr-0 py-20 md:py-24 items-center justify-self-center`}
`;
export const TwoColumnMobile = styled.div`
  ${tw`lg:hidden flex flex-col justify-center max-w-screen-xl py-20 md:py-24 items-center`}
  ${ImageColumn} {
